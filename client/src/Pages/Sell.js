...
//     const photos = photosArray.map(photo => URL.createObjectURL(photo)); // Convert File to data URL
...
//     e.preventDefault();
//     try {
//       const response = await axios.post('http://localhost:5000/vehicle', formData);
//       console.log(response.data);
//       alert('Vehicle added successfully!');
//       setFormData({
//         manufacturer: '',
